...
if ( ! function_exists( 'customFooter' ) ) {
	function customFooter() {
		...
		if($backgroundtype == 'footer_default_backgroundcolor') {
			 ...
			 echo '#footer-wrap, #footer .widget-title span { background-color: '.$backgroundcolor.' !important; }';
			
		} elseif($backgroundtype == 'footer_default_backgroundpattern') {
			
			echo '#footer-wrap, #footer .widget-title span { background: url('.get_template_directory_uri().'/images/pattern/'.$backgroundpattern.'); }';
			
		} elseif($backgroundtype == 'footer_default_backgroundimage') {
				
			echo '#footer-wrap, #footer .widget-title span { background: url('.$backgroundimage.') fixed; '; ?>
				...
				echo '#footer-wrap, #footer .widget-title span { background: url('.get_template_directory_uri().'/images/bg-textured/'.$backgroundtexture.'); ';	?>
				background-position: center top;
