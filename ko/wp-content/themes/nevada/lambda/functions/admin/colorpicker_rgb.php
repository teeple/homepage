 ...
 * @return string
 */
function option_tree_colorpicker_rgb( $value, $settings, $int ) 
{
?>
    ...
    <div class="section">
      <div class="element">
        ...
        jQuery(document).ready(function($) {  
          $('#<?php echo $value->item_id; ?>').ColorPicker({
			onSubmit: function(hsb, hex, rgb) {
            	$('#<?php echo $value->item_id; ?>').val(rgb.r+','+rgb.g+','+rgb.b);
            },
            ...
            onChange: function (hsb, hex, rgb) {
            	...
            	$('#cp_<?php echo $value->item_id; ?>').prev('input').attr('value', rgb.r+','+rgb.g+','+rgb.b);				
            }
          }).bind('keyup', function(){
            $(this).ColorPickerSetColor(this.value);
          });
        ...
        <div id="cp_<?php echo $value->item_id; ?>" class="cp_box">
          <div style="background-color:<?php echo ( isset ($settings[$value->item_id] ) ) ? 'rgb('.$settings[$value->item_id].')' : '#ffffff'; ?>;"> 
          </div>
        </div> 
