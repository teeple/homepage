...
if ( have_posts() ) : ?>
				<p class="search-title"><?php printf( __( 'Search Results for:<span> %s </span>', UT_THEME_NAME ), '' . get_search_query() . '' ); ?></p>
				<?php
...
<?php else : ?>
				<div id="post-0" class="post no-results not-found">
					<p class="search-title"><?php _e( 'Nothing Found', UT_THEME_NAME ); ?></p>
					
					<p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', UT_THEME_NAME ); ?></p>
						<?php get_search_form(); ?>
