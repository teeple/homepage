...
<div id="mh-board" class="content" class="clearfix">
	...
	<thead>
		<tr class="mh_b_header">		
			...
			<?php endif;?>
			<th class="mh_b_title" width="70%"><?php echo __('Title' ,'mhboard');?></th><th class="mh_b_author"><?php echo __('Author' ,'mhboard');?></th><th class="mh_b_date"><?php echo __('Date' ,'mhboard');?></th><th class="mh_b_count" width="70px"><?php echo __('Count' ,'mhboard');?></th>		
		</tr>
	</thead>
	<?php
		...
		<?php while ( $mh_query->have_posts() ) : $mh_query->the_post(); ?>
			...
			?>
				<tr>
					...
					</td><td class="mh_b_author"><?php echo $author;?></td><td class="mh_b_date"><?php echo get_the_date('Y/m/d');?></td><td class="mh_b_count"><?php echo $mh_board->get_count(get_the_ID());?></td>
				</tr>
				<?php
				$args= array (
					'post_type' => array('board'),
