...
$xmlfolder = 'nevada';
$unitedthemesAPI = 'http://api.unitedthemes.com/'.$xmlfolder.'/';

$xml = simplexml_load_file($unitedthemesAPI.'theme.xml'); ?>

<div id="lambda-option-panel" class="bootstrap-wpadmin">

<h2><?php echo $xml->theme[0]; ?></h2>
