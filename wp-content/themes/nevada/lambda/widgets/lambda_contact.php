...
class WP_Widget_Contact extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'lambda_widget_contact', 'description' => __( 'Insert your contact data in here!', UT_THEME_NAME) );
	...
	<label><?php _e('Address', UT_THEME_NAME); ?>: <textarea class="widefat" rows="16" cols="20" id="<?php echo $this->get_field_id('address'); ?>" name="<?php echo $this->get_field_name('address'); ?>"><?php echo $instance['address']; ?></textarea></label>
	<label><?php _e('Phone', UT_THEME_NAME); ?>: <input type="text" style="width:100%;" id="<?php echo $this->get_field_id('phone'); ?>" name="<?php echo $this->get_field_name('phone'); ?>" value="<?php echo esc_attr($instance['phone']); ?>" /></label>
    <label><?php _e('Fax', UT_THEME_NAME); ?>: <input type="text" style="width:100%;" id="<?php echo $this->get_field_id('fax'); ?>" name="<?php echo $this->get_field_name('fax'); ?>" value="<?php echo esc_attr($instance['fax']); ?>" /></label>
   	<label><?php _e('Email', UT_THEME_NAME); ?>: <input type="text" style="width:100%;" id="<?php echo $this->get_field_id('email'); ?>" name="<?php echo $this->get_field_name('email'); ?>" value="<?php echo esc_attr($instance['email']); ?>" /></label>
   	<label><?php _e('Internet', UT_THEME_NAME); ?>: <input type="text" style="width:100%;" id="<?php echo $this->get_field_id('internet'); ?>" name="<?php echo $this->get_field_name('internet'); ?>" value="<?php echo esc_attr($instance['internet']); ?>" /></label>
