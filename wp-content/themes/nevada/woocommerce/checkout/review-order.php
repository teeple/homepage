...
<div id="order_review">
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			<input type="submit" class="woo-button" name="woocommerce_checkout_place_order" id="place_order" value="<?php echo apply_filters('woocommerce_order_button_text', __('Place order', 'woocommerce')); ?>" />
